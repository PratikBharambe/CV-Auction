...
const AboutUs = () => {
  ...
  <li>
    <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
      <img src="/images/facebook.png" alt="Facebook" style={{ width: '24px', height: '24px', marginRight: '8px' }} />
      Facebook
    </a>
  </li>
  <li>
    <a href="https://twitter.com" target="_blank" rel="noopener noreferrer">
      <img src="/images/twitter.png" alt="Twitter" style={{ width: '24px', height: '24px', marginRight: '8px' }} />
      Twitter
    </a>
  </li>
  <li>
    <a href="https://Whatsapp.com" target="_blank" rel="noopener noreferrer">
      <img src="/images/whatsapp.jpg" alt="Whatsapp" style={{ width: '24px', height: '24px', marginRight: '8px' }} />
      Whatsapp
       </a>
  </li>
</ul>
      ...
      <footer>
        <p className="text-center">&copy; 2025 Commercial Vehicle Auction. All rights reserved.</p>
      </footer>
    </section>
  );
};
