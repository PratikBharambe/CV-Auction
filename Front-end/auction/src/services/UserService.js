...
const getVehicles = async () => {
  try {
    ...
    return response.data; // Return the vehicle data from the API response
  } catch (error) {
...
// Function to fetch details of a specific vehicle
...
// Function to place a bid on a specific vehicle
...
// Function to update the highest bid for a specific vehicle
