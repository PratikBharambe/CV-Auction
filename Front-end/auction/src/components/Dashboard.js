...
function Dashboard() {
  ...
  // State for managing the profile popup visibility
  ...
  // Function to be called when HostAuction is loaded
  ...
  // Automatically set the active tab to "HostAuction" when the component first loads
  useEffect(() => {
  ...
  return (
    <div className="container-fluid d-flex flex-column min-vh-100 px-4 py-3">
      ...
      {activeTab === "HostAuction" && <HostAuction />}
