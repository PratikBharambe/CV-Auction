...
// import { register } from './services/userService'; // Import the register function
...
function RegistrationForm() {
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      const response = await LoginAndRegisterService.registerUser(userData); // Call the registerUser method from LoginAndRegisterService
          ...
          <div className="card shadow-lg p-4 border-primary rounded-3 mt-4">
            <div className="card-body">
              ...
              <form id="registration-form" onSubmit={handleFormSubmit}>
                {!isFormSubmitted && (
                  <>
                    {/* Step 1: Personal and Login Details */}
                    <div className="row">
