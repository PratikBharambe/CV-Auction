...
function Frontpage() {
  ...
  // Function to handle login route navigation
  const loginRoute = () => {
    navigate("/login");
  };
  const registerRoute = () => {
        ...
        <div className="row justify-content-center">
          <div className="col-md-8">
            ...
            <div className="d-flex justify-content-start mb-2">
              <button
                className={`btn ${activeSection === "live" ? "btn-secondary" : "btn-outline-secondary"} me-2`}
                onClick={() => setActiveSection("live")}
              >
                Live Auction
              </button>
              <button
                className={`btn ${activeSection === "upcoming" ? "btn-secondary" : "btn-outline-secondary"}`}
          ...
          <div className="col-md-2">
            <button className="btn btn-primary mb-2 w-100" onClick={loginRoute}>Log In</button>
            <button className="btn btn-success mb-2 w-100" onClick={registerRoute}>Sign Up</button>
            <button className="btn btn-warning w-100" onClick={guestRoute}>Continue as Guest</button>
          </div>
        </div>
      </div>
