...
function RegistrationForm() {
  ...
  function validatePanCard(panCard) {
    ...
    if (!panCard) {
      ...
      return { isValid: false, message: "Invalid PAN Card format. It should be in the format ABCDE1234F" };
    } else {
  ...
  function handleFormSubmit(event) {
    ...
    let isValidPanCard = validatePanCard(PanCard);
    if (!isValidPanCard.isValid) {
      document.getElementById('pancard-error-msg').innerText = isValidPanCard.message;
    } else {
      document.getElementById('pancard-error-msg').innerText = '';
    }
    ...
    if (isValidUsername.isValid && isValidPassword.isValid && Upwd === confirmPassword && isValidPanCard.isValid) {
                    ...
                    <div className="row">
                      <div className="col-12 col-md-6 mb-3">
                        <div className="form-group">
                          ...
                          <small id="pancard-error-msg" className="form-text text-danger"></small>
                        </div>
                      </div>
                      <div className="col-12 col-md-6 mb-3">
                        <div className="form-group">
