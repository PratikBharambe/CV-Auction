...
import LoginAndRegisterService from '../services/LoginAndRegisterService';  // Adjust this path based on where your component is located
        ...
        <div className="col-md-8 col-lg-6">
          ...
          <>
            ...
            <div className="row">
              <div className="col-12 col-md-6 mb-3">
                <div className="form-group">
                  <label htmlFor="BankName" className="form-label">Bank Name<sup>optional</sup></label>
              ...
              <div className="col-12 col-md-6 mb-3">
                <div className="form-group">
                  <label htmlFor="BankBranch" className="form-label">Bank Branch<sup>optional</sup></label>
            ...
            <div className="row">
              <div className="col-12 col-md-6 mb-3">
                <div className="form-group">
                  <label htmlFor="AccholdName" className="form-label">Account holder name<sup>optional</sup></label>
              ...
              <div className="col-12 col-md-6 mb-3">
                <div className="form-group">
                  <label htmlFor="BankIFSC" className="form-label">Bank IFSC Code<sup>optional</sup></label>
            ...
            <div className="row">
              <div className="col-12 col-md-6 mb-3">
                <div className="form-group">
                  <label htmlFor="BankAccNo" className="form-label">Bank Account Number<sup>optional</sup></label>
              ...
              <div className="col-12 col-md-6 mb-3">
                <div className="form-group">
                  <label htmlFor="confirmBankAccNo" className="form-label">Confirm Account Number<sup>optional</sup></label>
