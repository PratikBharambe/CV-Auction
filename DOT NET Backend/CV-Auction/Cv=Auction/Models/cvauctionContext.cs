        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Admin>(entity =>
            {
                entity.HasKey(e => e.Aid)
                    .HasName("PK__Admin__DE508E2E0A83F1E3");

                entity.ToTable("Admin");

                entity.HasIndex(e => e.Aemail, "UQ__Admin__A0B4BEC38242DA44")
                    .IsUnique();
            ...
            modelBuilder.Entity<AllowedUser>(entity =>
            {
                entity.HasKey(e => e.Uid)
                    .HasName("PK__Allowed___DD7012648B074E99");
                ...
                entity.HasOne(d => d.PaymentNoNavigation)
                    ...
                    .HasConstraintName("FK__Allowed_U__payme__6754599E");

                entity.HasOne(d => d.UidNavigation)
                    .WithOne(p => p.AllowedUser)
                    .HasForeignKey<AllowedUser>(d => d.Uid)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Allowed_Use__uid__68487DD7");
            });

            modelBuilder.Entity<AuctionList>(entity =>
            {
                entity.HasKey(e => e.Eventid)
                    .HasName("PK__Auction___2DC8B111C3765F91");
            ...
            modelBuilder.Entity<AuctionStatusTrack>(entity =>
            {
                ...
                entity.HasOne(d => d.AllowedUserU)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__Auction_S__allow__6C190EBB");

                entity.HasOne(d => d.Vehicle)
                    .WithMany()
                    .HasForeignKey(d => d.Vehicleid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__Auction_S__vehic__6D0D32F4");
            });

            modelBuilder.Entity<CurrentAuction>(entity =>
            {
                entity.HasKey(e => e.Vehicleid)
                    .HasName("PK__Current___5BE2516A71758B4D");
                ...
                entity.HasOne(d => d.AidNavigation)
                    ...
                    .HasForeignKey(d => d.Aid)
                    .HasConstraintName("FK__Current_Auc__aid__47DBAE45");

                entity.HasOne(d => d.Event)
                    .WithMany(p => p.CurrentAuctions)
                    .HasForeignKey(d => d.Eventid)
                    .HasConstraintName("FK__Current_A__event__46E78A0C");
            });

            modelBuilder.Entity<DepositPayment>(entity =>
            {
                entity.HasKey(e => e.PaymentNo)
                    .HasName("PK__Deposit___ED1FE109070EFE1E");

                entity.ToTable("Deposit_Payment");

                entity.HasIndex(e => e.UtrNo, "UQ__Deposit___66060903E5BB04F7")
                    .IsUnique();
                ...
                entity.HasOne(d => d.UidNavigation)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__Deposit_Pay__uid__4BAC3F29");
            });
            ...
            modelBuilder.Entity<PaymentTransaction>(entity =>
            {
                entity.HasKey(e => e.TransactionId)
                    .HasName("PK__Payment___85C600AF2734EEA2");

                entity.ToTable("Payment_Transaction");

                entity.HasIndex(e => e.UtrNo, "UQ__Payment___66060903B7D2F04A")
                    .IsUnique();
                ...
                entity.HasOne(d => d.UidNavigation)
                    ...
                    .HasForeignKey(d => d.Uid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__Payment_Tra__uid__70DDC3D8");
            });

            modelBuilder.Entity<TotalVehicle>(entity =>
            {
                entity.HasKey(e => e.Vehicleid)
                    .HasName("PK__Total_Ve__5BE2516A76944171");
            ...
            {
                entity.HasKey(e => e.Uid)
                    .HasName("PK__Users__DD701264D0FFA976");

                entity.HasIndex(e => e.Uemail, "UQ__Users__D92E5BC0F2A73CBE")
                    .IsUnique();
            ...
            modelBuilder.Entity<VehicleDetail>(entity =>
            {
                entity.HasKey(e => e.DetailsId)
                    .HasName("PK__Vehicle___C3E443F41CA57E4D");
